...
type ContentItem struct {
	...
	// Embedded resource content (e.g., application/json)
	Resource *EmbeddedResource `json:"resource,omitempty"`
	// Resource link fields (for type=="resource_link")
...
// EmbeddedResource represents an inline resource payload per MCP spec
// For JSON content, set MimeType to "application/json" and provide Text with JSON string.
type EmbeddedResource struct {
	MimeType string `json:"mimeType"`
	Text     string `json:"text,omitempty"`
	// Optional fields (not used here):
	// URI  string `json:"uri,omitempty"`
